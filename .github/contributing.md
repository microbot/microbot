# Contributing to bot-github-comment-post

First and foremost, thank you! We appreciate that you want to contribute to bot-github-comment-post, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for bot-github-comment-post**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for bot-github-comment-post:

- star the [project](https://github.com/cyborgjs/bot-github-comment-post)
- tweet your support for bot-github-comment-post
...
- **version**: please note the version of bot-github-comment-post are you using
...
[so]: http://stackoverflow.com/questions/tagged/bot-github-comment-post